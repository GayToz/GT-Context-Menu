...
hook.Add("OnContextMenuOpen","GTContext_MenuOpen",function()
    ...
    ContextMenu.Paint = function(self, w, h)
        ...
        draw.RoundedBox(0, 0, 0, w, h, GTContext.style[color].color1)
        draw.RoundedBox(0, wei * 11, wei2 * 20, wei * 470, wei2 * 43, GTContext.style[color].color2)
        draw.DrawText(GTContext.TextServer, "GTContext_Title", wei * 150, wei2 * 15, Color(255, 255, 255, 255))
        draw.RoundedBox(0, wei * 11, wei2 * 78,wei * 470, wei2 * 30, GTContext.style[color].color2)
        draw.DrawText(GTContext.lang[langue].txt1, "GTContext_TextBase", wei * 170, wei2 * 75, Color(255, 255, 255, 255))
        draw.RoundedBox(0, wei * 11, wei2 * 360, wei * 470, wei2 * 30, GTContext.style[color].color2)
        draw.DrawText(GTContext.lang[langue].txt8, "GTContext_TextBase", wei * 165, wei2 * 358, Color(255, 255, 255, 255))
    end
